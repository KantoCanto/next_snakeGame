...
export default function SnakeGame() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-[#0F0F0F] to-[#1E1E1E]">
      <div className="bg-[#1E1E1E] rounded-lg shadow-lg p-8 w-full max-w-md min-w-[80vw] min-h-[80vh]">
        ...
        <div className="bg-[#0F0F0F] rounded-lg p-4 grid grid-cols-10 gap-1 min-h-[70vh]">
